		...
		<div>
			...
			<tbody>
				<?php
					...
					$sql="select * from noticeboard order by B_num desc";	
					...
					if(isset($_SESSION['id'])){
						...
						<button onclick="window.location.href='./profile.php'">내정보</button>
						</br>
				<?php
					}
					else {
				...
				?>
				<tr>
					<td width="70" align="center"><?php echo $row['B_num']?></td>
					<td width="500" align="center"><a href="./view.php?B_num=<?php echo $row['B_num']?>"><?php echo $row['title']?></td>
