...
<head>
    <meta charset="utf-8">
    <title>Market - Electronic Device</title>
</head>
<body>
    <div>
        <h4>Market - Electronic Device</h4>
        <table>
        <div>
            <thead>
                <tr>
            ...
            <tbody>
                <?php
                    ...
                    $sql="select * from noticeboard, product where kind='electronic_device' and B_num=P_num order by B_num desc";                    
